...
import org.zap.WireHelpers.FollowFarsResult;
...
public class SegmentReaderTest {
    ...
    public void validSegmentWithNegativeOffsetShouldBeInBounds() {
        ...
        Verify it is valid with:
            zap decode --flat dksdk_std_schema.zap GenericReturn
        where the .zap comes from
        https://gitlab.com/diskuv/dksdk-schema/-/blob/afbf9564a60f2670f6b9dfb3c423fc55dd4c3013/src/dksdk_std_schema.zap
        */
